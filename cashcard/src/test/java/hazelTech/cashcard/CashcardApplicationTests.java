...
class CashcardApplicationTests {
	...
	void shouldNotAllowDeletionOfCashCardsTheyDoNotOwn() {
		...
		ResponseEntity<String> getResponse = restTemplate.withBasicAuth("kuamr2", "xyz789")
	...
	@Test
	@DirtiesContext
	void shouldDeleteAnExixtingCashCard() {
	...
	@Test
	void shouldNotUpdateACashCardThatDoesNotExit() {
	...
	void shouldCreateANewCashCard() {
		...
		DocumentContext documentContext = JsonPath.parse(getResponse.getBody());
		Number id = documentContext.read("$.id");
		Double amout = documentContext.read("$.amount");
		
		assertThat(id).isNotNull();
		assertThat(amout).isEqualTo(250.00);
	}
